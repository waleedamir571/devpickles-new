...
<div class="hero-canvas">
  ...
  <div class="hero-left-block rv-up" data-delay="200">
    <a href="#contact" class="signup-btn">Get Started</a>
    <p class="hero-tagline">Helping good businesses look as good online as they are in real life.</p>
  </div>
  <div class="hero-stats rv-up" data-delay="300">
    ...
    <div class="stat">
      ...
      <div class="stat-l">Leads & Conversions Generated</div>
    </div>
    <div class="stat-div"></div>
    <div class="stat">
  ...
  <div class="container">
    <div class="row align-items-center g-0 g-lg-5">
      ...
      <div class="col-lg-6 rv-left s2-left-col">
        <h2 class="s2-heading">Your Brand, Right <br> in Their Pocket</h2>
        <p class="s2-body mt-4">Give your customers a faster, more convenient way to engage with your brand through
          mobile apps built for smooth experiences, meaningful interactions, and lasting loyalty.</p>
  ...
  <div class="container sap-content">
    ...
    <div class="row justify-content-center">
      <div class="col-xl-7 col-lg-9 text-center rv-up">
        <h2 class="sap-heading">Less Waiting<span class="dot-g">.</span></h2>
        <h3 class="sap-sub">More Winning<span class="dot-g">.</span></h3>
        <p class="sap-desc mt-3">Fast, reliable, and built with your users in mind. Our websites help businesses attract
          attention, build trust, and turn traffic into opportunities.</p>
      </div>
    </div>
...
<section class="s-logos" id="logos">
  <div class="container">
    <p class="sap-desc mt-3 mb-5 text-center rv-up vis">We create powerful 2D designs and stunning 3D animations that
      help your brand <br>
      communicate clearly, stand out from the crowd, and connect with the right audience</p>
    <div class="bento">
  ...
  <div class="container grow-inner">
    ...
    <div class="row justify-content-center">
      <div class="col-xl-8 col-lg-8 text-center rv-up">
        <h2 class="grow-heading">Great Brands Never <br> Stand Still.</h2>
        <p class="grow-desc mt-3">Neither should their websites. We build digital experiences that evolve with your
          business,
          helping you stay relevant, competitive, and ready for what's next.</p>
      </div>
    </div>
    ...
    <div class="row g-4 mt-7 justify-content-center">
      <div class="col-lg-4 col-md-6 rv-up" data-delay="0">
        <div class="grow-svc-card">
          <h4 class="grow-svc-title">Brand Strategy</h4>
          <p class="grow-svc-desc">Create a memorable brand that earns confidence and attracts better clients.
          </p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 rv-up" data-delay="150">
        <div class="grow-svc-card">
          <h4 class="grow-svc-title">SEO Growth</h4>
          <p class="grow-svc-desc">Help customers find your business faster through strategic search visibility.</p>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 rv-up" data-delay="300">
        <div class="grow-svc-card">
          <h4 class="grow-svc-title">Performance Marketing</h4>
          <p class="grow-svc-desc">Move beyond likes and impressions. We launch targeted campaigns that strengthen your
            brand, generate quality leads, and increase revenue.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-auto text-center rv-up">
        <h2 class="price-heading">Premium Quality<span class="dot-g">.</span></h2>
        <h3 class="price-sub">Fair Pricing<span class="dot-g">.</span></h3>
    ...
    <div class="row g-0 features-row">
      <div class="col-lg-3 col-md-6 rv-up" data-delay="0">
        <div class="feat-col">
          ...
          <h4 class="feat-title">Custom Built</h4>
          <p class="feat-desc">Every business is different. That's why we create solutions tailored to your goals,
            needs,
            and long-term growth plans.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 rv-up" data-delay="100">
        <div class="feat-col">
          ...
          <h4 class="feat-title">Money Back Promise</h4>
          <p class="feat-desc">If we miss the mark or fail to deliver on time, we'll work with you or offer a refund.
          </p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 rv-up" data-delay="200">
        <div class="feat-col">
          ...
          <h4 class="feat-title">Client First</h4>
          <p class="feat-desc">Your satisfaction is at the heart of everything we do. We're committed to delivering work
      ...
      <div class="col-lg-3 col-md-6 rv-up" data-delay="300">
        <div class="feat-col feat-col-last">
          ...
          <h4 class="feat-title">Always Available</h4>
          <p class="feat-desc">Need help, updates, or support? Our team is here around the clock whenever you need us.
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="container team-wrap">
    <div class="row g-0 align-items-center">
      ...
      <div class="col-xl-7 col-lg-6 team-col-l rv-left">
        ...
        <p class="team-body rv-up" data-delay="100">We're not here to sell you another website. We're here to help your
          business grow. From
          custom web development and mobile apps to branding, SEO, and marketing, we create
          digital solutions that help businesses attract attention and turn visitors into customers.
          Every project is designed with purpose and built for performance. We focus on creating
          experiences that look great, work seamlessly, and help your brand stand out in an
          increasingly crowded digital world.</p>
