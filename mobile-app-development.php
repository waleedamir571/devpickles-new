    ...
    <div class="container">
        <div class="row align-items-center g-0 g-lg-5">
            ...
            <div class="col-lg-6 rv-left s2-left-col">
                <h2 class="s2-heading">Building the <br> Future of Mobiles.</h2>
                <p class="s2-body mt-4">Go beyond the browser. We build high-performance iOS and Android applications
                    designed to turn casual users into an active, loyal community through seamless interactions.</p>
                    ...
                    <div class="s2-phone s2-phone-left">
                        <div class="s2-phone-frame">
                            ...
                            <div class="s2-phone-screen">
                                <video src="assets/images/v1.mov" class="s2-screen-img" autoplay loop muted
                                    playsinline></video>
                            </div>
                        </div>
                    </div>
                ...
                class="s2-shield">
                    ...
                    <div class="s2-phone s2-phone-right">
                        <div class="s2-phone-frame">
                            <img src="assets/images/mobilebg.svg" alt="" class="s2-phone-frame-img">
                            <div class="s2-phone-screen">
                                <video src="assets/images/v2.MP4" class="s2-screen-img" autoplay loop muted
                                    playsinline></video>
                            </div>
                        </div>
                    </div>
...
<section class="s-sapforce" id="about">
    ...
    <div class="container sap-content">
        ...
        <div class="blueprint-cards-row">
            <div class="blueprint-card rv-up" data-delay="0">
                <div class="blueprint-icon">
                    <img src="assets/images/search.svg" alt="">
                </div>
                <h3 class="blueprint-title">01. Discovery</h3>
                <p class="blueprint-desc">We deep dive into your unique challenges, target audience, and market
                    landscape to define a clear roadmap.</p>
            </div>
            <div class="blueprint-card rv-up" data-delay="100">
                <div class="blueprint-icon">
                    <img src="assets/images/Design.svg" alt="">
                </div>
                <h3 class="blueprint-title">02. Design</h3>
                <p class="blueprint-desc">Our UI/UX experts craft intuitive, engaging interfaces that prioritize user
                    engagement and brand identity.</p>
            </div>
            <div class="blueprint-card rv-up" data-delay="200">
                <div class="blueprint-icon">
                    <img src="assets/images/Development.svg" alt="">
                </div>
                <h3 class="blueprint-title">03. Development</h3>
                <p class="blueprint-desc">Clean code meets perfect pixel. We build robust architectures using the latest
                    tech stacks like React Native.</p>
            </div>
            <div class="blueprint-card rv-up" data-delay="300">
                <div class="blueprint-icon">
                    <img src="assets/images/Launch.svg" alt="">
                </div>
                <h3 class="blueprint-title">04. Launch</h3>
                <p class="blueprint-desc">Deployment to stores, performance monitoring, and ongoing support to ensure
                    your app scales flawlessly.</p>
            </div>
        </div>
    </div>
...
<section class="s-advantages" id="advantages">
    <!-- Decorative blobs -->
    <div class="advantages-blob blob-1"></div>
    <div class="advantages-blob blob-2"></div>
    <div class="container advantages-content">
        <div class="advantages-header">
            <div class="advantages-left">
                <p class="advantages-tag">Our Advantages</p>
                <h2 class="advantages-heading">Engineered for Performance.<br>Built for Impact.</h2>
            </div>
            <div class="advantages-right">
                <p class="advantages-subtext">We don't just build apps, we build scalable digital solutions that grow
                    with you and evolve.</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-auto text-center rv-up">
                <h2 class="price-heading">Build for Impact</h2>
                <h3 class="price-sub">Engineered For Growth.</h3>
                <p class="sap-desc mt-3">From the first sketch to the final deployment, our structured approach ensures
                    precision and performance at every stage.</p>
            </div>
        </div>
        ...
        <div class="slider-container rv-up mt-5">
            <div class="phone-slider">
                <div class="slide-item">
                    <img src="assets/images/smallm.png" alt="Phone 1">
                </div>
                <div class="slide-item">
                    <img src="assets/images/smallm.png" alt="Phone 2">
                </div>
                <div class="slide-item">
                    <img src="assets/images/smallm.png" alt="Phone 3">
                </div>
                <div class="slide-item">
                    <img src="assets/images/smallm.png" alt="Phone 4">
                </div>
                <div class="slide-item">
                    <img src="assets/images/smallm.png" alt="Phone 5">
                </div>
            </div>
        </div>
